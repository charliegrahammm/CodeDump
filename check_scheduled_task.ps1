...
{
	$OutString = "CRITICAL: Last Run - $LastRun_Text $Interval_Text / Last Result - $LastResult (" + $ResultStatus + ")"
	Write-Host $OutString
	Exit 2
}
Else
{
	$OutString = "OK: Last Run - $LastRun_Text $Interval_Text Last Result - $LastResult (" + $ResultStatus + ")"
	Write-Host $OutString
	Exit 0
}
}
