...
winget install -e --id ShareX.ShareX;winget install -e --id Mozilla.Firefox;winget install -e --id Notepad++.Notepad++;winget install -e --id REALiX.HWiNFO;winget install -e --id Klocman.BulkCrapUninstaller
