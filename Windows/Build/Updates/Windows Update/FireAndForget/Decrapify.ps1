...
.SYNOPSIS  
    This script is a modified version of https://github.com/n1snt/Windows-Decrapifier
.DESCRIPTION  
    This will automatically remove various Windows 10 "features". There are various settings that can be commented/uncommented to suit specfic needs.
.NOTES  
    File Name  : Decrapify.ps1  
...
Get-ItemProperty -Path "HKCU:\SOFTWARE\Microsoft\Windows\CurrentVersion\Feeds" | Select-Object ShellFeedsTaskbarViewMode
